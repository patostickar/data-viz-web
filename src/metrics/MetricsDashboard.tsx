    ...
    <div className="bg-white rounded-lg shadow-lg p-4 mb-6">
      ...
      >
        <div>
          ...
          <p>Average: {avgRequestTime.toFixed(2)} ms</p>
          <p>Mode: {modeRequestTime.toFixed(2)} ms</p>
          <RequestTimeChart data={metrics} />
        </div>
        <div>
          <h3 className="font-semibold">Payload Size</h3>
          <p>Average: {(avgPayloadSize / 1024).toFixed(2)} KB</p>
          <p>Mode: {(modePayloadSize / 1024).toFixed(2)} KB</p>
