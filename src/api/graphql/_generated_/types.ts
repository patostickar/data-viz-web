...
export type GetSettingsQuery = { settings?: { NumPlotsPerChart: number; NumPoints: number } | null };
...
export function useGetSettingsSuspenseQuery(
  baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetSettingsQuery, GetSettingsQueryVariables>,
) {
